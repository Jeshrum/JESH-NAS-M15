...
5. **Limit entries** — you never chase, entries are clean and consistent
...
| Fed Chair Speech (market hours) | No trade |
| Earnings of major tech (AAPL, MSFT, NVDA) | Reduce size to 0.5% |
...
- [ ] Limit order is placed — NOT a market order
- [ ] SL and TP are set before walking away
...
1. **The signal is the signal.** Don't second-guess it after the backtest confirmed it.
2. **A loss is not a mistake.** 47.2% of trades lose. That's built into the math.
3. **Missing a trade is better than a bad trade.** If you're not sure, don't trade.
4. **One bad day doesn't define the strategy.** 16 years of data backs it.
5. **Protect the account first. Profits second.**
