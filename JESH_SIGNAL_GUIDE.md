...
**What triggered it:**
1. 15m close crossed ABOVE the 9:30 AM NY First Bar High
...
**What triggered it:**
1. 15m close crossed BELOW the 9:30 AM NY First Bar Low
...
| R:R | Risk to reward ratio (3:1 = win 3× what you risk) |
...
- No more trades in that direction today (one TP per direction rule)
...
- Orders auto-cancelled at **11:30 AM NY (Lagos: 4:30 PM WAT summer · 5:30 PM WAT winter)**
- No loss, no trade. Move on.

### ⏰ Force Closed
- Trade was open but neither TP nor SL hit by **4:55 PM NY (Lagos: 10:55 PM WAT)**
...
| Blue background | Blue (faint) | 9:30–11:30 AM NY active session |
| Red background | Red (faint) | Force close window — no new trades |

---

## Session Window Quick Reference
...
> Signals only fire inside this window. Anything outside — ignore it.
